...
export declare class TokenMap {
     ...
     */
    registerNumberList(token: IResolvable): number[];
    /**
     * Create a unique number representation for this Token and return it
     */
     ...
     * Generate a unique string for this Token, returning a key
     */
    registerMap<V>(token: IResolvable, mapValue: V, displayHint?: string): {
        [key: string]: V;
    };
    /**
     ...
     * Reverse a number encoding into a Token, or undefined if the number wasn't a Token
     */
    lookupNumberList(xs: number[]): IResolvable | undefined;
    /**
     * Find a Token by key.
     *
