...
export declare class MantaBackend extends TerraformBackend {
    ...
    constructor(scope: Construct, props: MantaBackendConfig);
 ...
 * @deprecated CDK for Terraform no longer supports the manta backend. Terraform deprecated manta in v1.2.3 and removed it in v1.3.
 */
export interface DataTerraformRemoteStateMantaConfig extends DataTerraformRemoteStateConfig, MantaBackendConfig {
}
